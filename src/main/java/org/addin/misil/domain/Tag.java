...
public class Tag extends AbstractAuditingEntity implements Serializable {
    ...
    public Tag seminars(Set<Seminar> seminars) {
        this.seminars = seminars;
        return this;
    }

    public Tag addSeminars(Seminar seminar) {
        this.seminars.add(seminar);
        seminar.getTags().add(this);
        return this;
    }

    public Tag removeSeminars(Seminar seminar) {
        this.seminars.remove(seminar);
        seminar.getTags().remove(this);
        return this;
    }
